    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Condo", x => x.CondoId);
                    table.ForeignKey(
                        name: "FK_Condo_Building_CondoNumber",
                        column: x => x.CondoNumber,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CondosCondoId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserCondo", x => new { x.CondosCondoId, x.UsersId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserCondo_Condo_CondosCondoId",
                        column: x => x.CondosCondoId,
